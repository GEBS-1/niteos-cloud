...
STUDIO_MARKUP_CONTRACT = (
    ...
    "HARD RULE for marked areas: the edit MUST be visually obvious — returning a near-copy of Image 1 is a FAILED edit. "
    "Color semantics: "
    ...
    "2) CYAN / aqua / blue = REMOVE only the marked luminaire(s) and their beams completely; "
    ...
    "CRITICAL: never leave red/orange/cyan/blue brush strokes in the final image — marks are guides only."
)
